...
import { Heart, HelpCircle, Menu, ShoppingBag, User, X } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <Link href="/search?collection=hydrogen" className="text-sm font-semibold leading-6 text-gray-900">
            Hydrogen
          </Link>
          <Link href="/search?collection=oxygen" className="text-sm font-semibold leading-6 text-gray-900">
            Oxygen
          </Link>
          <Link href="/search?collection=accessories" className="text-sm font-semibold leading-6 text-gray-900">
            Accessories
          </Link>
        </div>
              ...
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <nav className="flex items-center space-x-4">
                    <Link href="/search?sale=true" className="text-sm font-medium text-red-600">
                      SALE
                    </Link>
                  </nav>
